<script module lang="ts">
    ...
    export const zuiMetadata = {
        ...
        bindings: [{description: '挂载期间的真实alertdialog引用。', name: 'ref', type: 'HTMLDivElement | null'}],
        ...
        since: '0.3.0',
        snippets: [{description: 'Title、Description、业务信息、Cancel与Action。', name: 'children', type: 'Snippet'}],
