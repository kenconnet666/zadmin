<script module lang="ts">
	...
	interface ZDescriptionListBaseProps extends HTMLAttributes<HTMLElement> {
...
{#if loading}
	...
	>
		...
		{:else}
			{#each Array.from({ length: loadingCount }, (_, index) => index) as index (`description-skeleton-${index}`)}
