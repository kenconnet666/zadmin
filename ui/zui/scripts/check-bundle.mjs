...
const COMPONENT_INCREMENTAL_GZIP_BUDGET = 8 * 1024;
...
const components = [
	...
	{ id: 'date-field', name: 'ZDateField', path: 'input/ZDateField.svelte' },
	{ id: 'date-picker', name: 'ZDatePicker', path: 'input/ZDatePicker.svelte' },
	{ id: 'date-range-picker', name: 'ZDateRangePicker', path: 'input/ZDateRangePicker.svelte' },
