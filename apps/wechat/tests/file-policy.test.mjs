...
test('classifies source changes into incremental, restart, and dependency boundaries', () => {
	...
	assert.equal(classifyChange('packages/svelte-taro/src/compiler/index.ts'), 'restart-taro');
	assert.equal(classifyChange('apps/wechat/src/app.config.ts'), 'restart-taro');
	assert.equal(classifyChange('packages/zui-taro/package.json'), 'dependencies-changed');
