...
| 维度                      |                    当前值 |                            总量或边界 |
| ------------------------- | ------------------------: | ------------------------------------: |
| Public component metadata |                       176 |                                   176 |
| Declared public props     |                      2269 |          metadata gaps 0; fallbacks 0 |
| Stable                    |                       141 |                          violations 0 |
| BrowserBehaviorVerified   |                       164 |                                   176 |
| VisuallyVerified          |                       159 |                                   176 |
| ProductionVerified        |                       168 |                                   176 |
| DesktopVerified           |                         0 |                                   176 |
...
2. **visual-evidence** (17 remaining): 补齐组件级几何、computed style或截图证据；普通浏览器交互断言不再冒充视觉验证。
3. **stable-promotion** (20 remaining): 逐项审查已满足门禁的experimental组件；禁止自动批量晋级。
4. **desktop-evidence** (176 remaining): 建立组件级WebView2/Desktop证据后再提升DesktopVerified。
