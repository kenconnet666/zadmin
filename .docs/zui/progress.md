...
| Declared public props     |                      1398 |         metadata gaps 0; fallbacks 0 |
| Stable                    |                       141 |                         violations 0 |
| BrowserBehaviorVerified   |                       141 |                                  141 |
| VisuallyVerified          |                         4 |                                  141 |
...
2. **visual-evidence** (137 remaining): 补齐组件级几何、computed style或截图证据；普通浏览器交互断言不再冒充视觉验证。
