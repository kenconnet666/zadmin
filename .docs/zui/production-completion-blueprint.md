...
状态：**历史收口蓝图**。2026-09-06 用户已授权自主审计与全面建设，无额外人工审阅关卡。最新范围和顺序以[完整能力对标与大范围建设路线图](./full-capability-roadmap-2026-09-06.md)为准，稳定证据以[稳定化验收附录](./stable-evolution-plan-2026-09-06.md)及当前提交记录为准。

基线：2026-09-01，`a10bed3`

范围：`@zadmin/zui`、`apps/docs`、相关 SvelteKit/WebView 消费夹具、CI/CD 与发布治理

关系：本文保留 2026-09-01 的问题与收口设计，不把历史数量或缺陷当作当前事实。当前源码、生成物和绑定提交的实际证据优先；新的能力建设由最新总纲统筹。
