...
stableCompliant：117；stableViolations：0；promotionEligibleExperimental：24。
...
| ZRadioGroup             | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/input/radio-group/doc.ts             |   1 |
| ZRadioGroupItem         | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/input/radio-group/doc.ts             |   1 |
...
| ZCarousel               | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/data-display/carousel/doc.ts         |   1 |
...
| ZList                   | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/data-display/list/doc.ts             |   1 |
| ZMeter                  | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/data-display/meter/doc.ts            |   2 |
| ZProgress               | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/data-display/progress/doc.ts         |   2 |
| ZSkeleton               | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/data-display/skeleton/doc.ts         |   2 |
...
| ZVirtualList            | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/data-display/virtual-list/doc.ts     |   2 |
...
| ZToast                  | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/feedback/toast/doc.ts                |   1 |
| ZToaster                | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/feedback/toast/doc.ts                |   2 |
...
| ZSeparator              | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/gene/separator/doc.ts                |   2 |
...
| ZVisuallyHidden         | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/gene/visually-hidden/doc.ts          |   2 |
...
| ZForm                   | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/input/form/doc.ts                    |   1 |
| ZFormField              | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/input/form/doc.ts                    |   1 |
...
| ZSegmented              | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/input/segmented/doc.ts               |   1 |
...
| ZTransfer               | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/input/transfer/doc.ts                |   1 |
| ZTreeSelect             | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/input/tree-select/doc.ts             |   2 |
| ZAspectRatio            | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/layout/aspect-ratio/doc.ts           |   2 |
| ZContainer              | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/layout/container/doc.ts              |   2 |
| ZStack                  | stable       | stableCompliant               | —        | apps/docs/src/content/components/layout/stack/doc.ts                  |   3 |
| ZCommand                | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/navigation/command/doc.ts            |   1 |
| ZCommandPalette         | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/navigation/command-palette/doc.ts    |   1 |
| ZPagination             | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/navigation/pagination/doc.ts         |   1 |
| ZTour                   | experimental | promotionEligibleExperimental | —        | apps/docs/src/content/components/overlay/tour/doc.ts                  |   1 |
