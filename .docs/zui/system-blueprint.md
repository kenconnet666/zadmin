...
> 状态：2026-08-30 起实施的历史系统蓝图。2026-09-06 的最新建设范围和执行总纲已转到[完整能力对标与大范围建设路线图](./full-capability-roadmap-2026-09-06.md)。用户已授权自主全面建设，旧组件上限和阶段性排除不再限制本轮范围。

2026-09-06 更新：全面对标同时包括已有与新增组件的 API、UI、主题、动画，以及删减、重命名、拆分合并和重新组合。当前已实现尺度和命名见[系统审计](./system-audit-2026-09-06.md)，后续设计见[视觉、主题与动画专项](./visual-theme-motion-plan-2026-09-06.md)和新总纲；下文保留原阶段设计作为历史依据。
