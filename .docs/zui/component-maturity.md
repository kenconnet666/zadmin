...
| ZAccordionContent       | navigation   |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZAccordionItem          | navigation   |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZAccordionTrigger       | navigation   |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZAlertDialog            | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/overlay/alert-dialog/doc.ts          |
...
| ZCombobox               | input        |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/input/combobox/doc.ts                |
| ZComboboxContent        | input        |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZComboboxInput          | input        |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZComboboxItem           | input        |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZContextMenu            | navigation   |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/navigation/context-menu/doc.ts       |
| ZContextMenuContent     | navigation   |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZContextMenuTrigger     | navigation   |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDialog                 | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/overlay/dialog/doc.ts                |
| ZDialogClose            | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDialogContent          | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDialogDescription      | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDialogOverlay          | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDialogTitle            | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDialogTrigger          | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDrawer                 | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/overlay/drawer/doc.ts                |
| ZDrawerClose            | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDrawerContent          | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDrawerDescription      | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDrawerOverlay          | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDrawerTitle            | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDrawerTrigger          | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDropdownMenu           | navigation   |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/navigation/dropdown-menu/doc.ts      |
| ZDropdownMenuContent    | navigation   |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZDropdownMenuTrigger    | navigation   |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZMenu                   | navigation   |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/navigation/menu/doc.ts               |
...
| ZPopconfirmContent      | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZPopconfirmDescription  | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZPopconfirmTitle        | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZPopconfirmTrigger      | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZPopover                | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/overlay/popover/doc.ts               |
...
| ZSelect                 | input        |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/input/select/doc.ts                  |
...
| ZTabsTrigger            | navigation   |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZTooltip                | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/overlay/tooltip/doc.ts               |
| ZTooltipContent         | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZTooltipGroup           | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZTooltipTrigger         | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | —                                                                     |
| ZTree                   | navigation   |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/navigation/tree/doc.ts               |
...
| ZBox                    | gene         |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/gene/box/doc.ts                      |
| ZButton                 | gene         |        Y |          Y |        Y |       Y |      — |       — |          Y | apps/docs/src/content/components/gene/button/doc.ts                   |
| ZCode                   | gene         |        Y |          Y |        Y |       Y |      Y |       — |          Y | apps/docs/src/content/components/gene/code/doc.ts                     |
| ZHeading                | gene         |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/gene/heading/doc.ts                  |
| ZIcon                   | gene         |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/gene/icon/doc.ts                     |
...
| ZProvider               | gene         |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/gene/provider/doc.ts                 |
| ZSeparator              | gene         |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/gene/separator/doc.ts                |
| ZText                   | gene         |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/gene/text/doc.ts                     |
| ZToggleButton           | gene         |        Y |          Y |        Y |       Y |      — |       — |          Y | apps/docs/src/content/components/gene/toggle-button/doc.ts            |
| ZVisuallyHidden         | gene         |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/gene/visually-hidden/doc.ts          |
| ZCalendar               | input        |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/input/calendar/doc.ts                |
| ZCascader               | input        |        Y |          Y |        Y |       Y |      Y |       — |          Y | apps/docs/src/content/components/input/cascader/doc.ts                |
| ZCheckbox               | input        |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/input/checkbox/doc.ts                |
| ZColorPicker            | input        |        Y |          Y |        Y |       Y |      Y |       — |          Y | apps/docs/src/content/components/input/color-picker/doc.ts            |
| ZDateField              | input        |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/input/date-field/doc.ts              |
| ZDatePicker             | input        |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/input/date-picker/doc.ts             |
| ZDateRangePicker        | input        |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/input/date-range-picker/doc.ts       |
| ZField                  | input        |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/input/field/doc.ts                   |
...
| ZInput                  | input        |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/input/input/doc.ts                   |
...
| ZTextarea               | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/textarea/doc.ts                |
| ZTimeField              | input        |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/input/time-field/doc.ts              |
...
| ZStack                  | layout       |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/layout/stack/doc.ts                  |
...
| ZTour                   | overlay      |        Y |          Y |        Y |       Y |      — |       — |          — | apps/docs/src/content/components/overlay/tour/doc.ts                  |
