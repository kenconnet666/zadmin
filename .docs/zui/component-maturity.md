...
Generated from 141 metadata components, 79 documentation modules, 141 API contract entries, and 123 test files.
...
| ----------------------- | ------------ | -------: | ---------: | -------: | ------: | -----: | ------: | ---------: | --------------------------------------------------------------------- |
| ZAccordion              | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/navigation/accordion/doc.ts          |
| ZAccordionContent       | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZAccordionItem          | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZAccordionTrigger       | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZAlertDialog            | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | apps/docs/src/content/components/overlay/alert-dialog/doc.ts          |
| ZAlertDialogAction      | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | —                                                                     |
| ZAlertDialogCancel      | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | —                                                                     |
| ZAlertDialogContent     | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | —                                                                     |
| ZAlertDialogDescription | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | —                                                                     |
| ZAlertDialogOverlay     | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | —                                                                     |
| ZAlertDialogTitle       | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | —                                                                     |
| ZAlertDialogTrigger     | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | —                                                                     |
| ZCombobox               | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/combobox/doc.ts                |
| ZComboboxContent        | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZComboboxInput          | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZComboboxItem           | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZContextMenu            | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/navigation/context-menu/doc.ts       |
| ZContextMenuContent     | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZContextMenuTrigger     | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZDialog                 | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | apps/docs/src/content/components/overlay/dialog/doc.ts                |
| ZDialogClose            | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | —                                                                     |
| ZDialogContent          | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | —                                                                     |
| ZDialogDescription      | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZDialogOverlay          | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | —                                                                     |
| ZDialogTitle            | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | —                                                                     |
| ZDialogTrigger          | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          Y | —                                                                     |
| ZDrawer                 | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/overlay/drawer/doc.ts                |
| ZDrawerClose            | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZDrawerContent          | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZDrawerDescription      | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZDrawerOverlay          | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZDrawerTitle            | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZDrawerTrigger          | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZDropdownMenu           | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/navigation/dropdown-menu/doc.ts      |
| ZDropdownMenuContent    | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZDropdownMenuTrigger    | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMenu                   | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/navigation/menu/doc.ts               |
| ZMenuCheckboxItem       | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMenuGroup              | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMenuItem               | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMenuLabel              | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMenuRadioGroup         | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMenuRadioItem          | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMenuSeparator          | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMenuSub                | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMenuSubContent         | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMenuSubTrigger         | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMultiSelect            | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/multi-select/doc.ts            |
| ZMultiSelectContent     | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMultiSelectItem        | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZMultiSelectTrigger     | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZPopconfirm             | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/overlay/popconfirm/doc.ts            |
| ZPopconfirmAction       | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZPopconfirmCancel       | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZPopconfirmContent      | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZPopconfirmDescription  | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZPopconfirmTitle        | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZPopconfirmTrigger      | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
...
| ZRadioGroup             | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/radio-group/doc.ts             |
| ZRadioGroupItem         | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZSelect                 | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/select/doc.ts                  |
| ZSelectContent          | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZSelectItem             | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZSelectTrigger          | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZTabs                   | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/navigation/tabs/doc.ts               |
| ZTabsList               | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZTabsPanel              | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZTabsTrigger            | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZTooltip                | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/overlay/tooltip/doc.ts               |
| ZTooltipContent         | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZTooltipGroup           | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
| ZTooltipTrigger         | overlay      |        Y |          Y |        Y |       Y |      Y |       — |          — | —                                                                     |
...
| ZMeter                  | data-display |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/data-display/meter/doc.ts            |
| ZProgress               | data-display |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/data-display/progress/doc.ts         |
| ZSkeleton               | data-display |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/data-display/skeleton/doc.ts         |
...
| ZCalendar               | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/calendar/doc.ts                |
| ZCascader               | input        |        Y |          Y |        Y |       Y |      Y |       — |          Y | apps/docs/src/content/components/input/cascader/doc.ts                |
| ZCheckbox               | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/checkbox/doc.ts                |
| ZColorPicker            | input        |        Y |          Y |        Y |       Y |      Y |       — |          Y | apps/docs/src/content/components/input/color-picker/doc.ts            |
| ZDateField              | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/date-field/doc.ts              |
| ZDatePicker             | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/date-picker/doc.ts             |
| ZDateRangePicker        | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/date-range-picker/doc.ts       |
...
| ZNumberField            | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/number-field/doc.ts            |
| ZPinInput               | input        |        Y |          Y |        Y |       Y |      Y |       — |          Y | apps/docs/src/content/components/input/pin-input/doc.ts               |
| ZSegmented              | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/segmented/doc.ts               |
| ZSlider                 | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/slider/doc.ts                  |
...
| ZTimeField              | input        |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/input/time-field/doc.ts              |
...
| ZCommand                | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/navigation/command/doc.ts            |
| ZCommandPalette         | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/navigation/command-palette/doc.ts    |
| ZPagination             | navigation   |        Y |          Y |        Y |       Y |      Y |       — |          — | apps/docs/src/content/components/navigation/pagination/doc.ts         |
